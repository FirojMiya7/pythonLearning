mystr = "feroz is a good boy"       #hamilaii thaha nai xa ki yo sab character haru index ma kaam garxa
#maile yettikai run garey bhani k e pani output aaudaina  but after adding print 
mystreg = "Ferozisagoodboy"
...
print(mystreg.isalnum())            #->True     alphanumeric value like email where gaps are not present

print(mystr.isalpha())              #->False
print(mystr.endswith("boy"))        #->True also case sensitive if "Boy" was given then it will be false
print(mystr.count("o"))             #->There are 4 o present in string mystr.
print(mystr.capitalize())           #->First letter lai capital gardinxa if small ma xa bhani.
print(mystr.lower())                #->Whole sentence lai naii lower ma convert gardinxa ani
print(mystr.upper())                #->whole sentence laii upper case ma convert gardinxa.
print(mystr.find("good"))           #->index 11 dekhi start bhanera dekhaunxa so yesari find garna sajilo hunxa.

print(mystr.replace("is" , "are"))  #->yesari hamile whole word or letter lai nai replace garna sakinxa
